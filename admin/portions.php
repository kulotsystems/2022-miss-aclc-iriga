...
<head>
    ...
    <script src="<?php echo $path; ?>js/admin_portions.js?<?php echo $script_version;?>"></script>
    <title>Portions ~ Admin | <?php echo $app_name; ?></title>
</head>
...
<div class="container-fluid" id="main-content">
    <div class="row">
        ...
        <div class="col-sm-10">
            <?php require $path."html/admin_portions.html"?>
        </div>
    </div>
</div>
</body>
